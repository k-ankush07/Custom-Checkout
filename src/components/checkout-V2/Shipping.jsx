...
import shipAddress from '../../images/ship.webp';
...
export default function Shipping({selectedShipping,currency,setSelectedShipping,shipping,pin,selectedCountry,
  ...
  return (
    <div className="checkout-contact shipping checkout-v2">
...
//                       const hasFreeShipping = discounts?.some(d => {
//                         const discount = d?.node?.discount;
//                         return (
//                           discount?.__typename === "DiscountAutomaticFreeShipping" &&
//                           discount?.status === "ACTIVE" &&
//                           discount?.minimumRequirement?.greaterThanOrEqualToSubtotal?.amount &&
//                           parseFloat(discount.minimumRequirement.greaterThanOrEqualToSubtotal.amount) <= (finalTotal + totalEstimatedTax) &&
//                           selectedCountry.includes(countryCode)
//                         );
//                       });
